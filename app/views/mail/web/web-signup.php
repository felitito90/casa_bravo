...
if (preg_match('/admin./', $resetLink)) {
    $resetLink = YII_ENV_DEV ? preg_replace('/admin./', 'public_html/', $resetLink) : preg_replace('/admin./', '', $resetLink);
}
?>
    <!DOCTYPE html
                            ...
                            <td style="border: 1px solid rgba(101,164,179,.5);background-color: #ffffff;padding: 2rem 1rem;font-family:'Open Sans', Arial, sans-serif; font-size:13px; line-height:22px; color:#797979;">
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    ...
                                    <tr>
                                        ...
                                        <?= Yii::t('app', 'Para iniciar a ordenar algo en nuestro menú solo tienes que confirmar la dirección de tu correo electrónico: ') ?>. <br class="em_hide"><br class="em_hide">
                                    </tr>
                                    <tr>
                                        <td valign="top" align="center">
                                            <a href="<?= $resetLink ?>" class="btn" target="_blank" style="background-color: #feae39;font-family:'Open Sans', Arial, sans-serif;font-size:17px;font-weight:bold;color:#ffffff;display: inline-block;padding: .5rem 1rem;text-decoration: none">
                                                <?= Yii::t('app', 'Confirma la dirección de tu correo electrónico') ?>
                                            </a>
                                        </td>
                                    </tr>
                                    <tr>
                        ...
                        <tr>
                            <td valign="top" align="center">
                                <table border="0" cellspacing="0" cellpadding="0" align="center">
                                    <tr>
                                        <td valign="top">
                                            <a href="https://www.instagram.com/casabravomx" target="_blank" style="text-decoration:none;"><img src="https://www.sendwithus.com/assets/img/emailmonks/images/fb.png" width="26" height="26" style="display:block;font-family: Arial, sans-serif; font-size:10px; line-height:18px; color:#feae39; " border="0" alt="Fb" /></a>
                                        </td>
                                        <td width="7">&nbsp;</td>
                                        <td valign="top">
                                            <a href="https://www.facebook.com/casabravomx" target="_blank" style="text-decoration:none;"><img src="https://www.sendwithus.com/assets/img/emailmonks/images/insta.png" width="26" height="26" style="display:block;font-family: Arial, sans-serif; font-size:10px; line-height:18px; color:#feae39; " border="0" alt="Instagram" /></a>
                                        </td>
                                    </tr>
                                </table>
                            </td>
                        ...
                        <tr>
                            <td align="center" style="font-family:'Open Sans', Arial, sans-serif; font-size:12px; line-height:18px; color:#848789;">
                                <span style="text-decoration:underline;"><a href="#" target="_blank"
                                    style="text-decoration:underline; color:#848789;"><?= Yii::t('app', 'Teléfono') ?>: <i>+52 442 241 9813</i></a></span> &nbsp;&nbsp;|&nbsp;&nbsp;<span class="em_hide">
                        </td>
                    </tr>
                    <tr>
                        <td height="35" class="em_height">&nbsp;</td>
