                                                            ...
                                                            <table class="header-row" width="528" cellspacing="0" cellpadding="0" border="0" style="table-layout: fixed;">
                                                                <tbody>
                                                                    <tr>
                                                                        ...
                                                                        <?= Yii::t('app', 'Solicito un presupuesto para los paquetes del operador') ?> "<i><?= $operator ?></i>". <br><br></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td class="header-row-td" width="528" style="font-family: Arial, sans-serif; font-weight: normal; line-height: 19px; color: #444444; margin: 0px; font-size: 16px; padding-bottom: 8px; padding-top: 10px;" valign="top" align="left">
                                                                            <?= Yii::t('app', 'Nombre del viajero') ?>: <i><?= $customer_name ?></i> <br><?= Yii::t('app', 'Correo electrónico del viajero') ?>: <i><?= $customer_email ?></i>
                                                                        </td>
                                                                    </tr>
                                                                </tbody>
                                                            </table>
